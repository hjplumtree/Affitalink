...
const theme = extendTheme({
  ...
  styles: {
    global: {
      "html, body": {
        bg: "linear-gradient(180deg, #f7f9fc 0%, #ffffff 24%, #f9fcff 100%)",
        color: "ink.900",
      },
      body: {
        minHeight: "100vh",
        backgroundImage:
          "radial-gradient(circle at 0 0, rgba(245, 22, 96, 0.06) 0, transparent 24%), radial-gradient(circle at 100% 0, rgba(10, 178, 198, 0.07) 0, transparent 22%)",
      },
      "::selection": {
        bg: "brand.200",
        color: "#0f1117",
    ...
    Button: {
      ...
      variants: {
        ...
        accent: {
          bg: "brand.500",
          color: "white",
          boxShadow: "0 12px 30px rgba(245, 22, 96, 0.24)",
